...
$iconClasses = Flux::classes('size-[18px]')
...
$classes = Flux::classes()
    ->add('h-10 in-data-flux-sidebar-on-mobile:h-11 relative flex items-center gap-3 rounded-lg')
    ...
    <flux:button-or-link :attributes="$attributes->class($classes)" data-flux-sidebar-item>
        ...
        <?php if ($slot->isNotEmpty()): ?>
            <div class="
                ...
                flex-1 text-[15px] font-medium truncate [[data-nav-footer]_&]:hidden [[data-nav-sidebar]_[data-nav-footer]_&]:block" data-content>{{ $slot }}</div>
        <?php endif; ?>
